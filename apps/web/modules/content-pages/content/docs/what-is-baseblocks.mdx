...
A page inside a site. Pages are organized in a tree and can be nested into child pages. Each page owns its content directly.

### Structure

Columns, tabs, and spacers are structure blocks inside page content.

### Block

A piece of page content. Headings, paragraphs, images, code blocks, callouts, and more.

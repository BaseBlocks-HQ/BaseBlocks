...
- **Draft** is what you build in the editor. Edits, new pages, and content changes all go to draft. Visitors never see draft.
...
Make all your changes in the editor. Add pages, update structure, edit content. Nothing is visible to visitors yet.
...
Publishing copies the entire site — all pages and their content blocks. Individual page publishing is not currently supported.

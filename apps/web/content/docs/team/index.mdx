...
From the dashboard, click **New Team**. Enter a name and choose a slug.

The slug becomes the subdomain for all sites in the workspace. It must be lowercase and hyphen-separated. Choose carefully — changing it later changes all your site URLs.

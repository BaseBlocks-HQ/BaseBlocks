...
import { FileIcon, getFileTypeColor } from "@/components/file-viewer/file-ui";
...
function toPreviewFile(file: FileData, documentId?: string): PreviewFile {
  return {
...
export function FileRenderer({ content }: ElementRendererProps<"file">) {
  ...
  const closePreview = useCallback(() => {
    ...
    setPreviewFile(null);
  }, [pathname, previewFile?.documentId, router, searchParams]);

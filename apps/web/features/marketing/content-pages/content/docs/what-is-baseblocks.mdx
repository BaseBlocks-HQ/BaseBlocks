...
A page inside a site. Pages are organized in a tree and can be nested into child pages. Each page has sections, columns, and blocks.

### Section

A structural row on the page. A section owns one or two columns where blocks are placed.

### Block

A piece of content inside a column. Headings, paragraphs, images, code blocks, callouts, and more.

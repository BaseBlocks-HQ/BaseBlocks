...
- **Header** — site switching, the editor beta notice, sharing, the published-site shortcut, and publishing controls
- **Rail** — pages, navigation, customization, and site settings
- **Page editor** — the block document. All edits save automatically.

The new editor is currently in beta. **Legacy Editor** in the header opens the preserved previous editor when you need it.

...
Then click **Deploy** in the editor header. BaseBlocks serves the latest saved
content at the generated site URL. Private sites require team authentication;
public sites can be indexed by search engines.
